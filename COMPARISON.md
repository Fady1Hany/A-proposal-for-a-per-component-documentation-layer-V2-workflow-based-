...
|---|---|---|
| **Field ownership** | Split: auto-generated structural fields (`location`, `depends_on`, `used_by`) vs hand-authored intent fields (`change_impact`, `targeted_verification`, `notes`), with `targeted_verification`  | All workflow-produced; humans review and edit after. The `Affected By` field is exclusively produced by Workflow 4. |
